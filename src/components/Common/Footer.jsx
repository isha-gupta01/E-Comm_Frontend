...
const Footer = () => {
    return (
        <footer className=' border-t md:mx-10 py-12'>
            <div className='container mx-auto grid grid-cols-1 md:grid-cols-4 gap-8 px-4 lg:px-0'>
                <div>
                    ...
                    {/* Newsletter form */}
                    <form className='flex'>
                        <input type='email' placeholder='Enter your Email' className='p-3 w-full text-sm border-l border-b border-gray-300 rounded-l-md focus:outline-none focus:ring-2 focus:ring-gray-500 transition-all' />
                        <button className='bg-black text-white px-6 py-3 text-sm rounded-r-md hover:bg-gray-800 transition-all' type='submit'>
                            Subscribe
                        </button>
                    </form>
            ...
            <div className='container mx-auto mt-12  px-4 lg:px-0 border-t border-gray-200 pt-6'>
                <p className='text-gray-500 text-sm tracking-tighter text-center'>&copy; 2025,  IshaGupta. All Rights Reserved</p>
            </div>
