    ...
    <div className='max-w-5xl mx-auto p-6 shadow-md rounded-md'>
        ...
        <form onSubmit={handleSubmit}>
            ...
            <div className="mb-6">
                ...
                <input type='text'  name="color" value={productData.colors?.join(",")} onChange={(e)=> setProductData({...productData,color: e.target.value.split(",").map((color)=>color.trim())})} className='w-full border border-gray-300 rounded-md p-2' required/>
            </div>
